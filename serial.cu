...
__host__ void compute_force_within_block(set<int>& block, particle_t* particles){
...
//Called in compute_force_grid
__host__ void compute_force_between_blocks(set<int>& block_A, set<int>& block_B, particle_t* particles){
...
__host__ void move_to_another_block(int i, double old_x, double old_y,
...
__host__ void compute_force_grid(particle_t* particles){
...
__host__ void move_particles(particle_t* particles, int n){
...
__host__ void generateGrid(particle_t* particles, int n){
...
__host__ void simulate_particles(particle_t* particles, int n, FILE* fsave, int argc, char** argv){
